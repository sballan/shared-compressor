...
describe(`Node`, () => {
    ...
    it(`is constructed with a key and value`, () => {
        const node = new node_1.Node("myKey", "myValue");
        expect(node).toBeDefined();
    });
    ...
    it(`can access an array of all the nodes in the map with the nodes property`, () => {
        const node = new node_1.Node("myKey", "myValue");
        const node1 = new node_1.Node('myKey', 'myValue');
        const node2 = new node_1.Node('myOtherKey', 'myOtherValue');
        const node3 = new node_1.Node('myThirdKey', 'myThirdValue');
