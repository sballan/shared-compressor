...
xdescribe(`Manager`, () => {
    ...
    let manager = new manager_1.Manager(client);
    ...
    xit(`can write a terminal to redis by passing a Terminal to writeTerm()`, (done) => {
        ...
        const term = new tokens_1.Terminal(termString);
    ...
    it(`can write an array of terminals to redis by passing a Terminal[] to writeTerms()`, (done) => {
        ...
        const term1 = new tokens_1.Terminal(termString1);
        const term2 = new tokens_1.Terminal(termString2);
    ...
    it(`can write a nonterminal to redis by passing a Nonerminal to writeNonterm()`, (done) => {
        ...
        const term1 = new tokens_1.Terminal(termString1);
        const term2 = new tokens_1.Terminal(termString2);
        const nonterm = new tokens_1.Nonterminal([term1, term2]);
        let nontermKey;
